...
Containerized deployment for experienced users. Docker support is on the roadmap.
...
See [VPS Deployment](/cloud/getting-started/vps#option-b-custom-domain-with-caddy) for Caddy/Nginx setup.

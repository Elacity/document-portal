...
This installs Node.js, WireGuard, stealth transports, builds PC2, and starts it automatically.
...
Your Pi can register a free `yourname.ela.city` subdomain with automatic HTTPS, right from the PC2 dashboard:

1. Open your PC2 at `http://raspberrypi.local:4200` (or your Pi's IP)
2. Go to **Settings → Network**
3. Register your subdomain

Your node connects out to the Boson network and becomes reachable at `https://yourname.ela.city` — even behind your home router, with no manual port forwarding required.

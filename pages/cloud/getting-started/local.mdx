...
```bash
# Replace VERSION with the version you downloaded (e.g. 1.0.0)
...
<Callout type="info">
**Find the volume name:** After opening the `.dmg`, run `ls /Volumes/` to see the exact name (e.g. `ElastOS 1.0.0-arm64`). Use that in the command above.
</Callout>

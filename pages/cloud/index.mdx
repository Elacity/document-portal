...
Pick your platform and get running in minutes:

- [VPS Server](/cloud/getting-started/vps) — Always-on, $5-12/month, recommended
- [NVIDIA Jetson](/cloud/getting-started/jetson) — GPU-accelerated private AI
- [Raspberry Pi](/cloud/getting-started/raspberry-pi) — Home hardware sovereignty
- [Local Install](/cloud/getting-started/local) — Try it on your Mac/Linux/Windows
- [Docker](/cloud/getting-started/docker) — Containerized deployment

→ [See all install options](/cloud/getting-started)
